...
//API地址配置
var rateApiUrl = '/api/Public/FindRate?address=TLrfwzSsXw3nxSa2Q5PfiCqtCwnc5hHHHH';						//兑换汇率信息API
var rankingApiUrl = '/api/Public/FindRanking?asset={currency}&type={type}';	//排行榜信息API，currency=trx/usdt，type=newest/day/week/month
